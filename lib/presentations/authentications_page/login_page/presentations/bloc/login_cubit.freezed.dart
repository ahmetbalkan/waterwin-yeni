...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginStatus status, String errorMessage, bool isObscure});
}
...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(status: $status, errorMessage: $errorMessage, isObscure: $isObscure)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      ...
      required final bool isObscure}) = _$LoginStateImpl;
